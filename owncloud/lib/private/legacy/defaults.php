...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultName = 'Impressico'; /* short name, used when referring to the software */
		$this->defaultTitle = 'Impressico-iCloud'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'http://impressico.com';
